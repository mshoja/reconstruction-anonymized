...
%
% NOTE: When burg.m is used 'stand-alone', it does NOT subtract the mean.
% NOTE: Since mode=1 is numerically unstable, I (JSE) modified the code
% such that always mode=3 is used instead of mode=1 (line 183). Also line
% 241 is modified, because it is also unstable.
